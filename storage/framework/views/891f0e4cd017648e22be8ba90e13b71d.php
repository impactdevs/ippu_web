...
<head>
    ...
    <title>Event Certificate - <?php echo e($event->name); ?></title>
</head>
<body style="background-color: #f5f5f5; font-family: sans-serif; padding: 20px;">
    ...
    <div style="background-color: #0044cc; padding: 20px; text-align: center; color: white;">
        <img src="<?php echo e(url('/logo.png')); ?>" alt="Event Logo" width="200" height="100">
    ...
    <div style="padding: 20px;">
        ...
        <ul>
            ...
            <li><strong>Event Dates:</strong> <?php echo e($formattedRange); ?></li>
        </ul>
    </div>
...
<?php /**PATH /Users/katendenicholas/Desktop/laravel/ippu_web/resources/views/mails/event-certificate.blade.php ENDPATH**/ ?>