                    ...
                    <div class="table-responsive">
                        <table class="table dataTable">
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="cust_tr" data-url="<?php echo e(url('admin/customers',\Crypt::encrypt($customer['id']))); ?>" data-id="<?php echo e($customer['id']); ?>">
                                    <td class="Id">
                                        
                                            <a href="<?php echo e(url('admin/customers',\Crypt::encrypt($customer['id']))); ?>" class="btn btn-outline-primary">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete customer')): ?>
                                                    <div class=" ms-2">
                                                        ...
                                                        <a href="#" class="mx-3 bg-danger btn btn-sm  align-items-center bs-pass-para" data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" ><i class="las la-trash text-white"></i></a>
                                                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\ppu_prod\resources\views/admin/customer/index.blade.php ENDPATH**/ ?>