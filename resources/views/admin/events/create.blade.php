                ...
                <form action="{{ route('events.store') }}" method="POST" class="m-0 p-0" enctype="multipart/form-data">
                    <div class="card-body row">
                        ...
                        <div class="mb-3 col-lg-12">
                            ...
                            <div>
                                <input type="radio" id="normal_event" name="event_type" value="Normal"
                                    {{ old('event_type', 'Normal') == 'Normal' ? 'checked' : '' }}>
                                <label for="normal_event">Normal</label>

                                <input type="radio" id="annual_event" name="event_type" value="Annual"
                                    {{ old('event_type') == 'Annual' ? 'checked' : '' }}>
                        ...
                        <div class="mb-3 col-lg-4">
                            ...
                            <input type="text" name="rate" id="rate" class="form-control number_format" value="0"
                                value="{{ @old('rate') }}" />
                            @if ($errors->has('rate'))
                        ...
                        <div class="mb-3 col-lg-4">
                            ...
                            <input type="text" name="member_rate" id="member_rate" class="form-control number_format" value="0"
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="file" name="attachment_name" id="attachment_name" class="form-control"
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="file" name="banner_name" id="banner_name" class="form-control"
                        ...
                        <div id="annual_event_fields" style="display: none;">
                            ...
                            <div class="mb-3 col-lg-12">
                                ...
                                <input type="text" name="organizing_committee" id="organizing_committee"
                                    class="form-control" value="{{ @old('organizing_committee') }}" />
                                @if ($errors->has('organizing_committee'))
                                    <div class='error small text-danger'>{{ $errors->first('organizing_committee') }}
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="mb-3 col-lg-12">
                                ...
                                <input type="date" name="annual_event_date" id="annual_event_date"
                                    class="form-control" value="{{ @old('annual_event_date') }}" />
