    ...
    <button type="submit">Download Certificates</button>
                        ...
                        <table class="table table-striped dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="checkbox" name="attendees[]" value="{{ $attendence->user->id }}">
                                    </td>
                                    <td>{{ $attendence->user->name }}</td>
                                    <td>{{ $attendence->user->phone_no }}</td>
                                    <td>{{ $attendence->user->email }}</td>
                                    <td>
                                        <a href="{{ url('admin/cpds/attendence/'.$cpd->id.'/'.$attendence->user->id) }}" class="btn btn-sm btn-primary mr-2 mb-2">
                                            Email Certificate
                                        </a>
                                        <a href="{{ url('admin/cpds/download_certificate/'.$cpd->id.'/'.$attendence->user->id) }}" class="btn btn-sm btn-warning mb-2">
