                                    ...
                                    {{-- @if(\Auth::user()->type=='company') --}}
                                        <td class="text-end">
                                            ...
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center cp_link" data-link="<iframe src='{{url('/form/'.$form->code)}}' title='{{ $form->name }}'></iframe>" data-bs-toggle="tooltip" title="{{__('Click to copy iframe link')}}"><i class="text-white ti ti-frame"></i></a>
                                            </div>
                                            ...
                                            <div class="action-btn bg-secondary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ url('admin/form_field',$form->id) }}" data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title="{{__('Convert into Lead Setting')}}" data-title="{{__('Convert into Lead Setting')}}">
                                                    <i class="text-white las la-exchange-alt"></i>
                                                </a>
                                            </div>


                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center cp_link" data-link="{{url('/form/'.$form->code)}}" data-bs-toggle="tooltip" title="{{__('Click to copy link')}}"><i class="text-white las la-copy"></i></a>
                                            </div>

                                            {{-- @can('manage form field') --}}
                                                <div class="action-btn bg-secondary ms-2">
                                                    <a href="{{url('admin/form_builders/'.$form->id)}}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" title="{{__('Form field')}}"><i class="text-white ri-grid-fill"></i></a>
                                                </div>
                                            {{-- @endcan --}}

                                            {{-- @can('view form response') --}}
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="{{url('admin/form_response/'.$form->id)}}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" title="{{__('View Response')}}"><i class="text-white las la-eye"></i></a>
                                                </div>
                                            {{-- @endcan --}}
