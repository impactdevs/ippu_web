...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/libs/datatables/responsive/2.2.9/css/responsive.bootstrap.min.css') }}" />
...
<body>
                    ...
                    <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart" aria-labelledby="page-header-cart-dropdown">
                        ...
                        <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                            {{-- <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <span
                                    class="position-absolute topbar-badge unread_notifications fs-10 translate-middle badge rounded-pill bg-danger">0<span
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-auto dropdown-tabs">
                                                <span class="badge badge-soft-light fs-13"> <span
                                                        class="unread_notifications"></span> New</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('storage/profiles/' . Auth::user()->profile_pic) }}"
                                        onerror="this.onerror=null;this.src='{{ asset('assets/images/users/user-dummy-img.jpg') }}';"
                                        alt="Header Avatar">
                                    <span class="text-start ms-xl-2">
                                        <span
                                            class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ ucwords(\Auth::user()->name) }}</span>
                                        <span
                                            class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{ \Auth::user()?->account_type?->name }}</span>
                                    </span>
                                </span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="dropdown-divider"></div> --}}
                                <a class="dropdown-item" href="javascript:void(0);"><i
                                        ...
                                        class="align-middle">Lifetime Points :
                                        <b>{{ \Auth::user()->points }}</b></span></a>
    ...
    <div id="modal-general" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        style="display: none;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if (editorElement) {
                ...
                console.warn('CKEditor element not found on this page.');
            }
        ...
        function load_data(data_url) {
            $.ajax({
                ...
                beforeSend: function() {
                    $("#modal-general-content").html(
                        '<div class="text-center text-muted"><i>Loading ...</i></div>')
                },
                ...
                error: function(xhr) {
                    $("#modal-general-content").html(
                        '<div class="alert bg-danger text-center">Unable to load data. <a href="javascript:void(0);" class="text-bold-700 text-white" onclick="reload_data()"><i>Retry Again</i></a></div>'
                    )
                }
            })
        }
                ...
                e1.on("change", function(t) {
                    ! function(e, t, a) {
                        var n, o = e.next("label"),
                            i = o.html();
                        t && t.files.length > 1 ? n = (t.getAttribute("data-multiple-caption") || "")
                            .replace("{count}", t.files.length) : a.target.value && (n = a.target.value
                                .split("\\").pop()), n ? o.find("span").html(n) : o.html(i)
                    }(e1, this, t)
