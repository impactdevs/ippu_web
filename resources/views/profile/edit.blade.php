    ...
    <form method="POST" class="needs-validation" action="{{ url('update_profile') }}" enctype="multipart/form-data" novalidate>
        ...
        <div class="card-body row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" name="alt_phone_no" value="{{ $user->alt_phone_no }}" pattern="^\+?[0-9]{10,15}$">
                <div class="invalid-feedback">* Phone number must be between 10-15 digits and may start with a +.</div>
            </div>
             <div class="col-md-4 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" name="nok_phone_no" value="{{ $user->nok_phone_no }}" required pattern="^\+?[0-9]{10,15}$">
                <div class="invalid-feedback">* Required</div>
                <div class="invalid-feedback">* Phone number must be between 10-15 digits and may start with a +.</div>
            </div>
        </div>
